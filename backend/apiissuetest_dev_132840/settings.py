"""
Django settings for apiissuetest_dev_132840 project.
...
ROOT_URLCONF = 'apiissuetest_dev_132840.urls'
...
WSGI_APPLICATION = 'apiissuetest_dev_132840.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "apiissuetest_dev_132840 API",
    "DESCRIPTION": "API documentation for apiissuetest_dev_132840 App",
    "VERSION": "v1",
}
